...
+ (NSData *)lubanCompressImage:(UIImage *)image withMask:(NSString *)maskName {
    ...
    return [self compressWithImage:image thumbW:thumbW thumbH:thumbH size:100 withMask:maskName];
}
