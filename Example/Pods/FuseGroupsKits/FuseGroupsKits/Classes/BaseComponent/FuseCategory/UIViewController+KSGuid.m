...
//    CGFloat btnY = CGRectGetMaxY(self.view.frame) * 0.83;
    ...
    removeBtn.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT);
    
//    removeBtn.layer.cornerRadius = 4;
//    removeBtn.layer.borderColor = [UIColor whiteColor].CGColor;
//    removeBtn.layer.borderWidth = 1.;
    
    //[removeBtn setTitle:@"Start Fuse" forState:UIControlStateNormal];
...
- (void)setupSubViews{
    ...
    //界面样式[UIScreen mainScreen].bounds.size
